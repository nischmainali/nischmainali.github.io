...
#+macro: epigraph @@hugo:{{< epigraph attribution="$1" source="$2" >}}$3{{< /epigraph >}}@@
...
{{{epigraph(Rabindranath Tagore,Stray Birds,The butterfly counts not months but moments\, and has time enough.)}}}
